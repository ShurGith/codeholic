...
<header class="navbar">
  <div class="flex px-12 justify-between items-center">
    ...
    <a href="{{ route('car.search') }}"
       class="rounded-full px-6  py-4 btn-primary btn-signup ">
    ...
    <div class="flex gap-4 ">
      @auth()
        <a href="{{ route('car.create') }}" class="rounded-full px-4 btn-add-new-car">
      ...
      @endauth
      @guest
        <a href="{{ route('signup') }}" class="rounded-full px-4 btn-primary btn-signup">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
               stroke="currentColor" style="width: 18px; margin-right: 4px">
